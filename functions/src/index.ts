...
export const onAdminAcceptPractitioner = regionalFunctions.firestore.document('/users/{upperLeverUser}/public_profile/{user}').onUpdate(GlobalFirestoreUserHandler.adminAcceptPractitioner.bind(GlobalFirestoreUserHandler));
export const onAdminRejectPractitioner = regionalFunctions.firestore.document('/users/{upperLeverUser}/public_profile/{user}').onDelete(GlobalFirestoreUserHandler.adminRejectPractitioner.bind(GlobalFirestoreUserHandler));